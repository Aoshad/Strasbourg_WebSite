...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php if ( is_sticky() ) { ?>
		<span class="sticky-label"><?php esc_html_e( 'Featured', 'decree' ); ?></span>
	<?php } ?>
	<div class="archive-post-wrap">
		<?php
		/**
		 * Name: decree_before_entry_container hook
		 *
		 * @hooked decree_archive_content_image - 10
		 */
		do_action( 'decree_before_entry_container' ); ?>
